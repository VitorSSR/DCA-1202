    ...
    while (sock.connected())
    {
        ...
        case mysocket_status::SOCK_OK:
            ...
            case CMD_NOVA_MSG:
                ...
                catch (int i)
                {
                    ...
                    emit signExibirErroMensagem(to_string(i));
                }
            ...
            case CMD_MSG_INVALIDA:
                ...
                try
                {
                    ...
                    emit signExibirErroMensagem(to_string(id));
                }
                catch (int i)
                {
        ...
        case mysocket_status::SOCK_TIMEOUT:
            if (!DC.salvar())
            {
                ...
                emit signExibirErroMensagem(DC.getNomeArq());
                //QMessageBox::critical(this,tr("Erro no salvamento do arquivo"), "N�o foi possivel salvar o arquivo"+DC.getNomeArq());
